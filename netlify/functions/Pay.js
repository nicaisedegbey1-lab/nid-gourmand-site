═══════════════════════════════════════════════════════════
//  NETLIFY FUNCTION : pay.js
//  Chemin : netlify/functions/pay.js
//
//  Cette fonction tourne côté serveur (pas dans le navigateur),
//  donc vos clés PayDunya restent secrètes.
//
//  CONFIGURATION VARIABLES D'ENVIRONNEMENT NETLIFY :
//  Dans app.netlify.com → votre projet → Configuration du projet
//  → Variables d'environnement → Ajouter :
//
//  PAYDUNYA_MASTER_KEY   = votre Master Key
//  PAYDUNYA_PRIVATE_KEY  = votre Private Key
//  PAYDUNYA_TOKEN        = votre Token
//  PAYDUNYA_MODE         = test  (ou live quand vous êtes prêt)
// ═══════════════════════════════════════════════════════════
